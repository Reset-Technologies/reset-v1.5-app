...
// each side needs its own copy. ActivityKit pairs the widget with the
// activities this module starts by the type's name and its Codable shape, so
// the two copies must match field for field.
@available(iOS 16.1, *)
